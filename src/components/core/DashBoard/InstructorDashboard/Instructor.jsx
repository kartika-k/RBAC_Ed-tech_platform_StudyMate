      ...
      {loading ? (
        ...
        <div>
          <div className="my-4 flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
            ...
            {/* Total Statistics */}
            <div className="flex flex-col min-w-[250px] rounded-md bg-richblack-800 p-4 sm:p-6">
          ...
          <div className="rounded-md bg-richblack-800 p-4 sm:p-6">
            ...
            <div className="flex items-center justify-between">
              <p className="text-lg sm:text-xl font-bold text-richblack-5">Your Courses</p>
              <Link to="/dashboard/my-courses">
                <p className="text-xs sm:text-sm font-semibold text-yellow-50">View All</p>
              </Link>
            </div>
            <div className="my-4 flex flex-col sm:flex-row items-start space-y-4 sm:space-y-0 sm:space-x-4">
              {courses.slice(0, 3).map((course) => (
                <div key={course._id} className="w-full sm:w-1/3">
                  ...
                  <div className="mt-3 w-full">
                    <p className="text-sm sm:text-base font-medium text-richblack-50">
                      {course.courseName}
                    </p>
                    <div className="mt-1 flex items-center space-x-2">
                      <p className="text-xs sm:text-sm font-medium text-richblack-300">
        ...
        <div className="mt-20 rounded-md bg-richblack-800 p-4 sm:p-6 py-12">
